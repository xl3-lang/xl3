...
|---|---|---|---|---|---|
| TypeScript | [`xl3-lang/xl3`](https://github.com/xl3-lang/xl3) | [`@xl3-lang/xl3`](https://www.npmjs.com/package/@xl3-lang/xl3) **1.0.0-rc.1** | XTL 0.1 (draft) | reference; **all current fixtures pass** ([live dashboard](./conformance/DASHBOARD.md)) | Browser + Node ≥ 20.12; in-memory object binding and `.xlsx` export in Browser/Node; runner via `npx xl3-conformance`; 3-TZ matrix in CI |
