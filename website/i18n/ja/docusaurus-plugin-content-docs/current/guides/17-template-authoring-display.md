...
[ADR-0046](/ja/spec/decisions/cell-formula-preservation) 参照、Excel が
...
[ADR-0049](/ja/spec/decisions/template-display-vs-render-output) の
contract:
...
- [ADR-0049 — Template-display vs render-output: intentional asymmetry](/ja/spec/decisions/template-display-vs-render-output)
