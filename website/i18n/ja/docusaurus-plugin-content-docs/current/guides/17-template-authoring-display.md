...
[ADR-0046](/ja/spec/decisions/0046-cell-formula-preservation) 参照、Excel が
...
[ADR-0049](/ja/spec/decisions/0049-template-display-vs-render-output) の
contract:
...
- [ADR-0049 — Template-display vs render-output: intentional asymmetry](/ja/spec/decisions/0049-template-display-vs-render-output)
- [ADR-0046 — Cell formula preservation contract](/ja/spec/decisions/0046-cell-formula-preservation)
- [Cookbook 16 — XTL 関数 vs Excel 数式](./16-xtl-vs-excel-formula.md)
- [`preview()` API ドキュメント](/ja/api/functions/preview)
