...
[ADR-0046](../../spec/decisions/0046-cell-formula-preservation.md) 参照、Excel が
...
[ADR-0049](../../spec/decisions/0049-template-display-vs-render-output.md) の
contract:
...
- [`preview()` API ドキュメント](../api/functions/preview.md)
