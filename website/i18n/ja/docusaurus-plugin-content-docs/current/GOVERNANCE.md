...
| **ポート著者** | XTL を別の言語で実装し、[`conformance/fixtures/`](https://github.com/xl3-lang/xl3/tree/main/conformance/fixtures) に対して適合性を測定する。 | 誰でも可。[IMPLEMENTATIONS.md](/ja/implementations) に掲載されます。 |
