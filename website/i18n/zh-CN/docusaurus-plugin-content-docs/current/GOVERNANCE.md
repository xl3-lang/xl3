...
| **移植作者** | 用其他语言实现 XTL；在 [`conformance/fixtures/`](https://github.com/xl3-lang/xl3/tree/main/conformance/fixtures) 上跑一致性测试。 | 任何人。在 [IMPLEMENTATIONS.md](/zh-CN/implementations) 中列出。 |
