...
|---|---|---|
| 0001 | ADR 0001 — `TODAY()` returns UTC date | `168-data-loss-date-time-component-round-trip`, `23-today-utc-dynamic` |
...
| 0006 | Stage 2 OOXML conformance comparison | `170-data-loss-numfmt-preserved-across-expansion`, `171-cf-dv-range-extension`, `172-outline-level-preservation`, `24-stage2-merge-preservation`, `25-stage2-style-numfmt-preservation`, `26-stage2-splice-merge-style-preservation`, `27-stage2-cross-writer-canonicalization`, `93-stage2-excel-authored-expected` |
...
| 0036 | Template feature preservation matrix | `123-feature-preservation`, `170-data-loss-numfmt-preserved-across-expansion`, `171-cf-dv-range-extension`, `172-outline-level-preservation` |
...
| 0040 | Preservation matrix amendment: CF / DV range extension + outline level | `171-cf-dv-range-extension`, `172-outline-level-preservation` |
...
| 0076 | Preservation matrix amendment: pivot tables, sparklines, structured tables, page breaks deferred to 1.1 | _(informational)_ |
| 0077 | XTL 1.0 ships with a single maintainer | _(informational)_ |
| 0078 | Source compatibility validation API | _(informational)_ |
| 0079 | Separate the 1.0 technical cut from the 1.x adoption track | _(informational)_ |
| 0080 | ADR 0080 — Opt-in formula reference adjustment | `173-formula-reference-adjustment`, `174-formula-sheet-reference-rejected` |
