...
| 0038 | `@group` and `@subtotal` directives | `132-group-single-level-subtotal`, `133-group-two-level-nested-subtotal`, `134-group-grand-total-via-outermost-subtotal`, `135-group-filter-composition` |
...
| 0050 | ADR 0050 — Template inputs accept XTL expressions in `default` / `label` / `description` | `131-inputs-with-xtl-default` |
