...
| 0066 | ADR 0066 — Column-scoped data block | `141-block-column-scoped-side-cells`, `142-block-column-scoped-side-formulas`, `143-block-shared-formula-side-cells`, `144-block-side-cells-after-block`, `145-block-bracket-outside-error` |
| 0067 | ADR 0067 — `@block` directive | `146-multi-block-explicit-two-tables`, `149-block-col-range-explicit`, `152-block-empty-table-error` |
| 0068 | ADR 0068 — Multi-block detection (strict mode) | `151-block-overlap-error` |
| 0069 | ADR 0069 — Per-block directive scoping | `153-directive-orphan-error` |
