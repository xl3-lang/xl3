...
import { runConformance, formatTextReport } from '../conformance-runner.js';
...
function die(msg: string): never {
  ...
  console.error('usage: xl3-conformance [--fixture-dir=<path>] [--filter=<tag>] [--spec-version=<x.y>] [--report=json|text]');
  process.exit(2);
}
