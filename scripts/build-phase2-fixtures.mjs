...
// ─────────────────────────────────────────────────────────────────
{
  ...
  rep.getCell('D2').value = 'Customer';
  rep.getCell('E2').value = 'Amount';
  rep.getCell('A3').value = '{{ [Customer] }}';
  rep.getCell('B3').value = '{{ [Amount] }}';
  rep.getCell('D3').value = '{{ [Customer] }}';
  ...
  er.getCell('A1').value = 'Customer';
  er.getCell('B1').value = 'Amount';
  er.getCell('D1').value = 'Customer';
  er.getCell('E1').value = 'Amount';
  er.getCell('A2').value = 'A';
  er.getCell('B2').value = 100;
  er.getCell('D2').value = 'A';
  er.getCell('E2').value = 100;
  er.getCell('A3').value = 'B';
  er.getCell('B3').value = 200;
  er.getCell('D3').value = 'B';
  er.getCell('E3').value = 200;
...
// ─────────────────────────────────────────────────────────────────
{
  ...
  rep.getCell('A2').value = 'Customer';
  rep.getCell('B2').value = 'Amount';
  rep.getCell('C2').value = 'Tier';
  rep.getCell('A3').value = '{{ [Customer] }}';
  rep.getCell('B3').value = '{{ [Amount] }}';
  rep.getCell('C3').value = '{{ [Tier] }}';
  await save(tpl, join(dir, 'template.xlsx'));
  ...
  er.getCell('A1').value = 'Customer';
  er.getCell('B1').value = 'Amount';
  er.getCell('C1').value = 'Tier';
  er.getCell('A2').value = 'X';
  er.getCell('B2').value = 100;
  er.getCell('C2').value = 'VIP';
  er.getCell('A3').value = 'Y';
  er.getCell('B3').value = 200;
  er.getCell('C3').value = 'Std';
  await save(exp, join(dir, 'expected.xlsx'));
...
// ─────────────────────────────────────────────────────────────────
{
  ...
  ws.getCell('B1').value = 'd';
  ws.getCell('C1').value = 'f';
