...
// =====================================================================
{
  ...
  rep.getCell('B1').value = '{{ @source Customers }}';
  rep.getCell('D1').value = '{{ @block D:E }}';
  rep.getCell('E1').value = '{{ @source Vendors }}';
  rep.getCell('A2').value = 'Customer';
  rep.getCell('B2').value = 'Total';
  rep.getCell('D2').value = 'Vendor';
  rep.getCell('E2').value = 'Region';
  rep.getCell('A3').value = '{{ [Name] }}';
  rep.getCell('B3').value = '{{ [Total] }}';
  rep.getCell('D3').value = '{{ [Name] }}';
  rep.getCell('E3').value = '{{ [Region] }}';
  await save(tpl, join(dir, 'template.xlsx'));

  const data = new ExcelJS.Workbook();
  const c = data.addWorksheet('Customers');
  c.getCell('A1').value = 'Name';
  c.getCell('B1').value = 'Total';
  c.getCell('A2').value = 'Acme';
  c.getCell('B2').value = 1000;
  c.getCell('A3').value = 'Beta';
  c.getCell('B3').value = 2000;
  const v = data.addWorksheet('Vendors');
  v.getCell('A1').value = 'Name';
  v.getCell('B1').value = 'Region';
  v.getCell('A2').value = 'Alpha Foods';
  v.getCell('B2').value = 'Seoul';
  v.getCell('A3').value = 'Gamma Foods';
  v.getCell('B3').value = 'Busan';
  v.getCell('A4').value = 'Delta Foods';
  v.getCell('B4').value = 'Daegu';
  ...
  e.getCell('A1').value = 'Customer';
  e.getCell('B1').value = 'Total';
  e.getCell('D1').value = 'Vendor';
  e.getCell('E1').value = 'Region';
  e.getCell('A2').value = 'Acme';
  e.getCell('B2').value = 1000;
  e.getCell('A3').value = 'Beta';
  e.getCell('B3').value = 2000;
  e.getCell('D2').value = 'Alpha Foods';
  e.getCell('E2').value = 'Seoul';
  e.getCell('D3').value = 'Gamma Foods';
  e.getCell('E3').value = 'Busan';
  e.getCell('D4').value = 'Delta Foods';
  e.getCell('E4').value = 'Daegu';
...
// =====================================================================
{
  ...
  // Block 2 at rows 5-7
  rep.getCell('A5').value = '{{ @block A:B }}';
  rep.getCell('B5').value = '{{ @source Vendors }}';
  rep.getCell('A6').value = 'Vendor';
  rep.getCell('B6').value = 'Region';
  rep.getCell('A7').value = '{{ [Name] }}';
  rep.getCell('B7').value = '{{ [Region] }}';
  await save(tpl, join(dir, 'template.xlsx'));
  ...
  e.getCell('A5').value = 'Vendor';
  e.getCell('B5').value = 'Region';
  e.getCell('A6').value = 'Alpha Foods';
  e.getCell('B6').value = 'Seoul';
  e.getCell('A7').value = 'Gamma Foods';
  e.getCell('B7').value = 'Busan';
  await save(exp, join(dir, 'expected.xlsx'));
...
// =====================================================================
{
  ...
  const exp = new ExcelJS.Workbook();
  const e = exp.addWorksheet('Report');
  e.getCell('A1').value = 'Item';
  e.getCell('B1').value = 'Qty';
  e.getCell('C1').value = 'Price';
  e.getCell('A2').value = 'Apple';
  e.getCell('B2').value = 3;
  e.getCell('C2').value = 10;
  e.getCell('A3').value = 'Banana';
  e.getCell('B3').value = 5;
  e.getCell('C3').value = 7;
  await save(exp, join(dir, 'expected.xlsx'));
...
// =====================================================================
{
  ...
  rep.getCell('A1').value = '{{ @block A:B }}';
  rep.getCell('B1').value = '{{ @filter [Status] = "VIP" }}';
  // Block 2: filter Status="Standard"
  rep.getCell('D1').value = '{{ @block D:E }}';
  rep.getCell('E1').value = '{{ @filter [Status] = "Standard" }}';
  rep.getCell('A2').value = 'VIP Customer';
  rep.getCell('B2').value = 'Amount';
  rep.getCell('D2').value = 'Standard Customer';
  rep.getCell('E2').value = 'Amount';
  rep.getCell('A3').value = '{{ [Name] }}';
  rep.getCell('B3').value = '{{ [Amount] }}';
  rep.getCell('D3').value = '{{ [Name] }}';
  rep.getCell('E3').value = '{{ [Amount] }}';
  await save(tpl, join(dir, 'template.xlsx'));
  ...
  ws.getCell('C2').value = 'VIP';
  ws.getCell('A3').value = 'Beta';
  ws.getCell('B3').value = 500;
  ws.getCell('C3').value = 'Standard';
  ws.getCell('A4').value = 'Gamma';
  ws.getCell('B4').value = 2000;
  ws.getCell('C4').value = 'VIP';
  ws.getCell('A5').value = 'Delta';
  ws.getCell('B5').value = 300;
  ws.getCell('C5').value = 'Standard';
  await save(data, join(dir, 'data.xlsx'));
  ...
  const exp = new ExcelJS.Workbook();
  const e = exp.addWorksheet('Report');
  e.getCell('A1').value = 'VIP Customer';
  e.getCell('B1').value = 'Amount';
  e.getCell('D1').value = 'Standard Customer';
  e.getCell('E1').value = 'Amount';
  e.getCell('A2').value = 'Acme';
  e.getCell('B2').value = 1000;
  e.getCell('A3').value = 'Gamma';
  e.getCell('B3').value = 2000;
  e.getCell('D2').value = 'Beta';
  e.getCell('E2').value = 500;
  e.getCell('D3').value = 'Delta';
  e.getCell('E3').value = 300;
  await save(exp, join(dir, 'expected.xlsx'));
...
// =====================================================================
{
  ...
  rep.getCell('A1').value = '{{ @block A:B }}';
  rep.getCell('D1').value = '{{ @block D:E }}';
  rep.getCell('A2').value = '#';
  rep.getCell('B2').value = 'Customer';
  rep.getCell('D2').value = '#';
  rep.getCell('E2').value = 'Customer';
  rep.getCell('A3').value = '{{ ROW() }}';
  rep.getCell('B3').value = '{{ [Name] }}';
  rep.getCell('D3').value = '{{ ROW() }}';
  rep.getCell('E3').value = '{{ [Name] }}';
  await save(tpl, join(dir, 'template.xlsx'));
  ...
  const e = exp.addWorksheet('Report');
  e.getCell('A1').value = '#';
  e.getCell('B1').value = 'Customer';
  e.getCell('D1').value = '#';
  e.getCell('E1').value = 'Customer';
  e.getCell('A2').value = 1;
  e.getCell('B2').value = 'Acme';
  e.getCell('A3').value = 2;
  e.getCell('B3').value = 'Beta';
  e.getCell('A4').value = 3;
  e.getCell('B4').value = 'Gamma';
  e.getCell('D2').value = 1;
  e.getCell('E2').value = 'Acme';
  e.getCell('D3').value = 2;
  e.getCell('E3').value = 'Beta';
  e.getCell('D4').value = 3;
  e.getCell('E4').value = 'Gamma';
  await save(exp, join(dir, 'expected.xlsx'));
