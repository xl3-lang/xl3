...
const dir =
  '/Users/wefun/workspaces/playground/xl3/conformance/fixtures/145-block-bracket-outside-error';
...
cfg.getCell('B1').value = 'bracket-outside';
cfg.getCell('A2').value = 'source_sheet';
cfg.getCell('B2').value = 'Data';
