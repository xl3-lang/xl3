...
// =====================================================================
{
  ...
  dws.getCell('A3').value = 'Beta';
  dws.getCell('B3').value = 200;
  dws.getCell('A4').value = 'Gamma';
  dws.getCell('B4').value = 300;
  ...
  ers.getCell('A2').value = 'Acme';
  ers.getCell('B2').value = 100;
  ers.getCell('A3').value = 'Beta';
  ers.getCell('B3').value = 200;
  ers.getCell('A4').value = 'Gamma';
  ers.getCell('B4').value = 300;
...
// =====================================================================
{
  ...
  dws.getCell('A1').value = 'Customer';
  dws.getCell('B1').value = 'Amount';
  dws.getCell('A2').value = 'X';
  dws.getCell('B2').value = 10;
  dws.getCell('A3').value = 'Y';
  dws.getCell('B3').value = 20;
  await save(data, join(dir, 'data.xlsx'));
  ...
  ers.getCell('A1').value = 'Customer';
  ers.getCell('B1').value = 'Amount';
  ers.getCell('A2').value = 'X';
  ers.getCell('B2').value = 10;
  ers.getCell('A3').value = 'Y';
  ers.getCell('B3').value = 20;
...
// =====================================================================
{
  ...
  const data = new ExcelJS.Workbook();
  const dws = data.addWorksheet('Data');
  dws.getCell('A1').value = 'Item';
  dws.getCell('B1').value = 'Qty';
  dws.getCell('A2').value = 'Apple';
  dws.getCell('B2').value = 3;
  dws.getCell('A3').value = 'Banana';
  dws.getCell('B3').value = 5;
  dws.getCell('A4').value = 'Cherry';
  dws.getCell('B4').value = 7;
  await save(data, join(dir, 'data.xlsx'));
  ...
  const exp = new ExcelJS.Workbook();
  const ers = exp.addWorksheet('Report');
  ers.getCell('A1').value = 'Item';
  ers.getCell('B1').value = 'Qty';
  ers.getCell('A2').value = 'Apple';
  ers.getCell('B2').value = 3;
  ers.getCell('A3').value = 'Banana';
  ers.getCell('B3').value = 5;
  ers.getCell('A4').value = 'Cherry';
  ers.getCell('B4').value = 7;
