...
// =====================================================================
{
  ...
  dws.getCell('A2').value = 'r1';
  dws.getCell('B2').value = 10;
  dws.getCell('A3').value = 'r2';
  dws.getCell('B3').value = 20;
  dws.getCell('A4').value = 'r3';
  dws.getCell('B4').value = 30;
  ...
  ers.getCell('A2').value = 'r1';
  ers.getCell('B2').value = 10;
  ers.getCell('A3').value = 'r2';
  ers.getCell('B3').value = 20;
  ers.getCell('A4').value = 'r3';
  ers.getCell('B4').value = 30;
